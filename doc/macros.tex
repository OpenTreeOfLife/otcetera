...
\newcommand{\simplification}[0]{\textsc{Simplification Action(s)}:\xspace}
\newcommand{\undoActions}[0]{\textsc{``Undo'' Simplification Action(s)}:\xspace}
\newcommand{\stepExplanation}[0]{\textsc{Explanation}:\xspace}
\newcommand{\stepInput}[0]{\textsc{Input}:\xspace}
\newcommand{\stepOutput}[0]{\textsc{Output}:\xspace}
\newcommand{\currImpl}[0]{\textsc{Current Impl.}:\xspace}
\newcommand{\implTODO}[0]{\textsc{TODO for Impl.}:\xspace}
\newcommand{\currURL}[0]{\textsc{URL for output}:\xspace}
...
\newcommand{\propinquity}{\texttt{propinquity}\xspace}
\newcommand{\induced}[2]{\matscr{I}(#1,#2)}
