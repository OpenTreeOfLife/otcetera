...
\begin{compactenum}
    ...
    \begin{compactenum}
        ...
        \item If $x$ is a polytomy; $M, N \leftarrow \textsc{ResolvingBipart}(x, v)$. If neither $M$ nor $N$ is an empty set then:
         \begin{compactenum}
...
\ENSURE Returns a pair of sets. If both elements returned are non-empty, then 
    ...
    can be moved to a newly created daughter in order to resolve $x$.
