...
These simplifications should not result in a different set of \MSWIPSD trees
    being attainable.
...
The input set of \ps subproblems is simply in that all of the labelled tips are treated
