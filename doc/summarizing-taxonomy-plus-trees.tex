...
\subsubsection{Conjecture: constraining uncontested taxa does not prevent any other
    \pss from being displayed}
...
However, these examples of ``implied'' or ``emergent'' \pss seem to require that the certain
...
a summary tree which both displays the \ps and attains the highest possible \SWIPSD score (the maximum score
based on all other input \pss that could be attained before the \ps was considered).
