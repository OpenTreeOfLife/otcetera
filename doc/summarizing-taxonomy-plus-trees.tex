...
\footnote{there used to be a conjecture by MTH to the contrary of this statement here.
...
\implTODO (1) there should probably be a simple tool to just print this out without requiring a db.\\
...
\subsection{Expand tips mapped to non-terminal taxa}
...
\subsection{Prune taxonomy down to tips represented in \expandedPhylo}
