	...
	public:
		...
		char runTest(const TestHarness &h) const {
			...
			for (;;) {
				...
				std::string full = "(((A1_ott1,(A2_ott2,A3_ott3))A_ott4,B1_ott5),B2_ott6,B3_ott7,((C1_ott9,C2_ott10),C3_ott11)C_ott12)life_ott14;\n";
				...
				auto i = 0;
				for (auto nd: iter_pre_n_const(nt->getRoot())) {
...
int main(int argc, char *argv[]) {
	std::vector<std::string> validfilenames = {"three-genus-synth.tre"};
